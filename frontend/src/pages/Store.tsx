                ...
                <div className="relative aspect-auto overflow-hidden bg-gray-200">
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
                    <button
                      ...
                      className="bg-white text-black rounded-lg px-6 py-3 font-bold uppercase tracking-wide text-xs transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300"
                    >
                      Quick Add
                    </button>
                  </div>
