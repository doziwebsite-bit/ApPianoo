...
const SocialIcon = ({ path, viewBox = "0 0 24 24" }: { path: string, viewBox?: string }) => (
  <svg className="w-5 h-5 fill-current" viewBox={viewBox} xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <path d={path} />
  </svg>
);
...
const SocialLinks: React.FC = () => {
  return (
    <nav className="flex flex-wrap justify-center gap-8 mb-8" aria-label="Réseaux sociaux">
      <a href={SOCIAL_LINKS.youtube} target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors" aria-label="YouTube - Alan Paul">
        <SocialIcon path="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
      </a>
      <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-pink-600 transition-colors" aria-label="Instagram - Alan Paul">
      ...
      <a href={SOCIAL_LINKS.tiktok} target="_blank" rel="noopener noreferrer" className="hover:text-pink-500 transition-colors" aria-label="TikTok - Alan Paul">
      ...
      <a href={SOCIAL_LINKS.spotify} target="_blank" rel="noopener noreferrer" className="hover:text-green-500 transition-colors" aria-label="Spotify - Alan Paul">
      ...
      <a href={SOCIAL_LINKS.deezer} target="_blank" rel="noopener noreferrer" className="hover:text-purple-500 transition-colors" aria-label="Deezer - Alan Paul">
