        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-4 sm:space-x-6">
              ...
              <button onClick={handleUserClick} className="p-1 hover:text-gray-500 transition-colors relative">
                <User size={20} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-8">
            ...
            <a href={SOCIAL_LINKS.appleMusic} target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors" title="Apple Music">
               <SocialIcon path="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm4.5 16.5c-1.66 0-3-1.34-3-3v-5l-4 1v6.5c0 1.66-1.34 3-3 3s-3-1.34-3-3 1.34-3 3-3c.55 0 1 .1 1.4.25V4.5l8.6-2v11c0 1.66-1.34 3-3 3z" />
            </a>
